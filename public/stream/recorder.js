(function(window){
  ...
  var WORKER_PATH = '/stream/recorderWorker.js';

  function getURL() {
    const txt = document.getElementById( 'sansadhakWorker')?.textContent;
    // const txt = `importScripts("http://localhost:3001/stream/recorderWorker.js")`
